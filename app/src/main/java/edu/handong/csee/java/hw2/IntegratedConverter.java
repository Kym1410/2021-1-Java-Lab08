...
/**
 * This is class of IntergratedConverter which contains main method
 * This class contains AllConverter class which contains setting methods (made by YeongMin Kim)
 * @link AllConverter, KMToMConverter, KMToMILEConverter, MILEToMConverter, TONToGConverter, TONToKGConverter, Util
 * @author JC
 */
public class IntegratedConverter {
     ...
     * In this class myConverter is made
     * @param args
     */
